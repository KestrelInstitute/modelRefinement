...
min(xs) == IF xs={} THEN MAX_TIME ELSE CHOOSE x \in xs : (\A y \in xs: x <= y)
...
DoNothingOnlyIfOK == DoNothing /\ CheckTimeConstraint'
...
\* Last modified Mon Oct 18 09:56:10 PDT 2021 by snedunu
